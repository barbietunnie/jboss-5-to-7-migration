...
public enum RuleActionEnum {
	...
	RMA_REQUEST_3(RuleNameEnum.RMA_REQUEST,3,RuleActionDetailEnum.TO_CSR,"$" + QueueNameEnum.RMA_REQUEST_INPUT.name()),
	...
	GENERIC_3(RuleNameEnum.GENERIC,3,RuleActionDetailEnum.TO_CSR,"$"+QueueNameEnum.SUBSCRIBER_CARE_INPUT),
