...
public enum EmailVariableEnum implements EnumInterface {
	...
	SubscriberName(EmailVariableType.Custom,"Subscriber_Data","FirstName,LastName",false,"Valued Subscriber",
			"SELECT CONCAT(c.FirstName, ' ', c.LastName) as ResultStr FROM subscriber_data c, email_addr e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1;","jpa.external.SubscriberNameResolver"),
	SubscriberFirstName(EmailVariableType.Custom,"Subscriber_Data","FirstName",false,"Valued Subscriber",
			"SELECT CONCAT(c.FirstName) as ResultStr FROM subscriber_data c, email_addr e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1;","jpa.external.SubscriberNameResolver"),
	SubscriberLastName(EmailVariableType.Custom,"Subscriber_Data","LastName",false,"Valued Subscriber",
			"SELECT CONCAT(c.LastName) as ResultStr FROM subscriber_data c, email_addr e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1;","jpa.external.SubscriberNameResolver"),
	SubscriberAddress(EmailVariableType.Custom,"Subscriber_Data","StreetAddress",false,"",
			"SELECT CONTAC_WS(',',c.StreetAddress2,c.StreetAddress) as ResultStr FROM subscriber_data c, email_addr e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1;","jpa.external.SubscriberNameResolver"),
	SubscriberCityName(EmailVariableType.Custom,"Subscriber_Data","CityName",false,"",
			"SELECT CONCAT(c.CityName) as ResultStr FROM subscriber_data c, email_addr e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1;","jpa.external.SubscriberNameResolver"),
	SubscriberStateCode(EmailVariableType.Custom,"Subscriber_Data","StateCode",false,"",
			"SELECT CONTAC_WS(',',c.StateCode,c.ProvinceName) as ResultStr FROM subscriber_data c, email_addr e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1;","jpa.external.SubscriberNameResolver"),
	SubscriberZipCode(EmailVariableType.Custom,"Subscriber_Data","ZipCode",false,"",
			"SELECT CONCAT_WS('-',c.ZipCode5,ZipCode4) as ResultStr FROM subscriber_data c, email_addr e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1;","jpa.external.SubscriberNameResolver"),
	SubscriberCountry(EmailVariableType.Custom,"Subscriber_Data","Country",false,"",
			"SELECT CONCAT(c.Country) as ResultStr FROM subscriber_data c, email_addr e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1;","jpa.external.SubscriberNameResolver"),
