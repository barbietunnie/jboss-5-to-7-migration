...
public class RuleSubruleMapTest {
	...
	public void ruleSubruleMapService1() {
		List<RuleSubruleMap> lst1 = service.getByRuleName(RuleNameType.HARD_BOUNCE.getValue());
		assertFalse(lst1.isEmpty());
		
		List<RuleSubruleMap> lst2 = service.getByRuleName(RuleNameType.MAILBOX_FULL.getValue());
		assertFalse(lst2.isEmpty());

		RuleLogic rlg1 = logicService.getByRuleName(RuleNameType.HARD_BOUNCE.getValue());
