...
public class StaticCodes {
	...
	private static SelectItem[] mailProtocolItems = {
		new SelectItem(MailProtocol.POP3.getValue(), "POP3"),
		new SelectItem(MailProtocol.IMAP.getValue(), "IMAP")
	};
	...
	private static SelectItem[] smtpServerTypeItems = {
		new SelectItem(MailServerType.SMTP.getValue(), "SMTP"),
		new SelectItem(MailServerType.EXCHANGE.getValue(), "Exchange")
	};
