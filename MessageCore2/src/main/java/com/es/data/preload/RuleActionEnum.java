...
public enum RuleActionEnum {
	...
	HARD_BOUNCE_2(RuleNameEnum.HARD_BOUNCE,2,RuleActionDetailEnum.SUSPEND,
			"$"+EmailAddressType.FINAL_RCPT_ADDR.getValue()+","+"$"+EmailAddressType.ORIG_RCPT_ADDR.getValue()),
	...
	SEND_MAIL_1(RuleNameEnum.SEND_MAIL,1,RuleActionDetailEnum.SENDMAIL,"$"+EmailAddressType.TO_ADDR.getValue()),
	RMA_REQUEST_1(RuleNameEnum.RMA_REQUEST,1,RuleActionDetailEnum.SAVE,null),
	RMA_REQUEST_2(RuleNameEnum.RMA_REQUEST,2,RuleActionDetailEnum.ACTIVATE,"$"+EmailAddressType.FROM_ADDR.getValue()),
	...
	UNSUBSCRIBE_2(RuleNameEnum.UNSUBSCRIBE,2,RuleActionDetailEnum.UNSUBSCRIBE,"$"+EmailAddressType.FROM_ADDR.getValue()),
	...
	SUBSCRIBE_2(RuleNameEnum.SUBSCRIBE,2,RuleActionDetailEnum.SUBSCRIBE,"$"+EmailAddressType.FROM_ADDR.getValue()),
	SUBSCRIBE_3(RuleNameEnum.SUBSCRIBE,3,RuleActionDetailEnum.ACTIVATE,"$"+EmailAddressType.FROM_ADDR.getValue()),
	...
	GENERIC_2(RuleNameEnum.GENERIC,2,RuleActionDetailEnum.ACTIVATE,"$"+EmailAddressType.FROM_ADDR.getValue()),
