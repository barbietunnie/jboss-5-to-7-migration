...
public enum EmailVariableEnum implements EnumInterface {
	...
	SubscriberName(EmailVariableType.Custom,"Subscriber","FirstName,LastName",false,"Valued Subscriber",
			"SELECT CONCAT(c.FirstName, ' ', c.LastName) as ResultStr FROM subscriber c, email_address e where e.EmailAddrId=c.EmailAddrId and e.EmailAddrId=?1","jpa.service.external.SubscriberNameResolver"),
	SubscriberFirstName(EmailVariableType.Custom,"Subscriber","FirstName",false,"Valued Subscriber",
			"SELECT c.FirstName as ResultStr FROM subscriber c, email_address e where e.EmailAddrId=c.EmailAddrId and e.EmailAddrId=?1","jpa.service.external.SubscriberNameResolver"),
	SubscriberLastName(EmailVariableType.Custom,"Subscriber","LastName",false,"Valued Subscriber",
			"SELECT c.LastName as ResultStr FROM subscriber c, email_address e where e.EmailAddrId=c.EmailAddrId and e.EmailAddrId=?1","jpa.service.external.SubscriberNameResolver"),
	SubscriberAddress(EmailVariableType.Custom,"Subscriber","StreetAddress",false,"",
			"SELECT CONTAC_WS(',',c.StreetAddress2,c.StreetAddress) as ResultStr FROM subscriber c, email_address e where e.EmailAddrId=c.EmailAddrId and e.EmailAddrId=?1","jpa.service.external.SubscriberNameResolver"),
	SubscriberCityName(EmailVariableType.Custom,"Subscriber","CityName",false,"",
			"SELECT c.CityName as ResultStr FROM subscriber c, email_address e where e.EmailAddrId=c.EmailAddrId and e.EmailAddrId=?1","jpa.service.external.SubscriberNameResolver"),
	SubscriberStateCode(EmailVariableType.Custom,"Subscriber","StateCode",false,"",
			"SELECT CONTAC_WS(',',c.StateCode,c.ProvinceName) as ResultStr FROM subscriber c, email_address e where e.EmailAddrId=c.EmailAddrId and e.EmailAddrId=?1","jpa.service.external.SubscriberNameResolver"),
	SubscriberZipCode(EmailVariableType.Custom,"Subscriber","ZipCode",false,"",
			"SELECT CONCAT_WS('-',c.ZipCode5,ZipCode4) as ResultStr FROM subscriber c, email_address e where e.EmailAddrId=c.EmailAddrId and e.EmailAddrId=?1","jpa.service.external.SubscriberNameResolver"),
	SubscriberCountry(EmailVariableType.Custom,"Subscriber","Country",false,"",
			"SELECT c.Country as ResultStr FROM subscriber c, email_address e where e.EmailAddrId=c.EmailAddrId and e.EmailAddrId=?1","jpa.service.external.SubscriberNameResolver"),
