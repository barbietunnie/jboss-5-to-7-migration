...
/**
 * Message-Driven Bean implementation class for: CustomerCareInput
 *
 */
@MessageDriven(
		activationConfig = {
			@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue"), 
			@ActivationConfigProperty(propertyName = "destination", propertyValue = "queue/customerCareInput"),
			@ActivationConfigProperty(propertyName = "maxSession", propertyValue = "2")
			}, 
		mappedName = "customerCareInput")
...
public class CustomerCareInput implements MessageListener {
	static final Logger logger = Logger.getLogger(CustomerCareInput.class);
	@Resource
	private MessageDrivenContext messageContext;
    /**
     * Default constructor. 
     */
    public CustomerCareInput() {
    }
