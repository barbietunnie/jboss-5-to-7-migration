...
@Remote(MailingListTimerRemote.class)
@Local(MailingListTimerLocal.class)
public class MailingListTimer implements MailingListTimerRemote, MailingListTimerLocal {
    ...
    public MailingListTimer() {
    	emailTemplateDao = (EmailTemplateDao) SpringUtil.getAppContext().getBean("emailTemplateDao");
    }
