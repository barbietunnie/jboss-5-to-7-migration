...
public enum EmailVariableEnum implements EnumInterface {
	...
	SubscriberAddress(EmailVariableType.Custom,"Subscriber_Data","StreetAddress",false,"",
			"SELECT CONTAC_WS(',',c.StreetAddress2,c.StreetAddress) as ResultStr FROM subscriber_data c, email_address e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1","jpa.service.common.external.SubscriberNameResolver"),
	...
	SubscriberStateCode(EmailVariableType.Custom,"Subscriber_Data","StateCode",false,"",
			"SELECT CONTAC_WS(',',c.StateCode,c.ProvinceName) as ResultStr FROM subscriber_data c, email_address e where e.Row_Id=c.EmailAddrRowId and e.Row_Id=?1","jpa.service.common.external.SubscriberNameResolver"),
